...
function App() {
  ...
  const favoriteBuildings = useMemo(() => {
    return buildings.filter(building => isFavorite(building.id));
  ...
  const handleGetDirections = (venue: string) => {
    ...
    if (targetBuilding) {
      ...
      setDirectionsTarget(venue);
      setActiveTab('map');
      
      // Show a notification or highlight the building
      setTimeout(() => {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">University Campus Guide</p>
              </div>
            </div>
                  ...
                  {directionsTarget && (
                    <div className="bg-green-100 border border-green-300 rounded-lg p-3 mb-4">
                      <p className="text-green-800 text-sm font-medium">
                        📍 Showing directions to: {directionsTarget}
                      </p>
                    </div>
                  )}
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Campus Navigator</h3>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">Emergency Services</a>
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">Campus Map</a>
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">Building Directory</a>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 University Campus Navigator. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
